...
if [ -e "$ENV_FILE" ] && [ "$FORCE" != true ]; then
    if [ "$IF_MISSING" = true ]; then
        ...
        upgraded=false
        for generated_key in GATEWAY_ENCRYPTION_KEY AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET AI_PLATFORM_AGENT_RUNTIME_MODEL_PLANE_INTERNAL_TOKEN; do
...
AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN_VALUE="$(copy_env_or_default AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN "$(generate_secret)")"
AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET_VALUE="$(copy_env_or_default AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET "$(generate_secret)")"
...
value_for_key() {
    ...
    case "$key" in
        ...
        AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN)
            printf '%s' "$AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN_VALUE"
            ;;
        AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET)
            printf '%s' "$AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET_VALUE"
            ;;
...
log_info "Generated local secrets for: POSTGRES_PASSWORD REDIS_PASSWORD JWT_SECRET GATEWAY_ASSISTANT_SHARED_SECRET GATEWAY_ENCRYPTION_KEY AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET AI_PLATFORM_AGENT_RUNTIME_MODEL_PLANE_INTERNAL_TOKEN DEFAULT_USER_PASSWORD"

COPIED_KEYS=""
for key in POSTGRES_PASSWORD REDIS_PASSWORD JWT_SECRET GATEWAY_ASSISTANT_SHARED_SECRET GATEWAY_ENCRYPTION_KEY AI_PLATFORM_AGENT_RUNTIME_INTERNAL_TOKEN AI_PLATFORM_AGENT_RUNTIME_LEASE_SIGNING_SECRET AI_PLATFORM_AGENT_RUNTIME_MODEL_PLANE_INTERNAL_TOKEN DASHSCOPE_API_KEY DASHSCOPE_CHAT_API_KEY DASHSCOPE_IMAGE_API_KEY DASHSCOPE_EMBEDDING_API_KEY DASHSCOPE_BASE_URL DASHSCOPE_CHAT_BASE_URL DASHSCOPE_CHAT_WIRE_PROTOCOL DASHSCOPE_EMBEDDING_BASE_URL DASHSCOPE_IMAGE_BASE_URL DASHSCOPE_RERANK_BASE_URL DASHSCOPE_RERANK_REQUEST_SCHEMA DASHSCOPE_RERANK_INSTRUCT GOOGLE_API_KEY GEMINI_API_KEY GOOGLE_API_BACKEND GOOGLE_CHAT_BACKEND VERTEX_API_KEY VERTEX_CHAT_API_KEY OPENAI_API_KEY OPENAI_BASE_URL OPENAI_WIRE_PROTOCOL ANTHROPIC_API_KEY DEEPSEEK_API_KEY TAVILY_API_KEY SILICONFLOW_API_KEY KB_EMBEDDING_PROVIDER KB_EMBEDDING_API_KEY KB_EMBEDDING_MODEL KB_EMBEDDING_DIMENSION AUTH_ALLOWED_EMAIL_DOMAIN DEFAULT_USER_PASSWORD DOCGEN_LLM_MODEL DOCGEN_LLM_ENDPOINT GATEWAY_IMAGE FRONTEND_IMAGE ASSISTANT_IMAGE KNOWLEDGE_IMAGE MIGRATE_IMAGE; do
