# Codex Harness Single-Kernel Runtime Migration

- Owner: AI--Platfform
- Repository: `/Users/yang/projects/AI--Platfform-codex-migration`

## Goal

Replace the Python AgentLoop with a Codex Open Harness single kernel while preserving platform contracts, tenant safety, and rollback.

## Non-goals

- Running Codex as a tool or sub-agent inside the Python `AgentLoop`.
- Copying Codex product UI, host configuration, credentials, or coding-only defaults.
