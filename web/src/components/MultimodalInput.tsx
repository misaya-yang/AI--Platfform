        ...
        <div className="px-4 pt-3 pb-2 flex flex-wrap gap-2 border-b border-border/50">
          {files.map((f, index) => (
            <div
              ...
              className={cn(
                "relative group rounded-lg px-3 py-2 text-xs flex items-center gap-2 transition-colors",
                f.status === "error"
            ...
            >
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-1.5 -right-1.5 bg-foreground/80 text-background rounded-full p-0.5 hover:bg-foreground"
