...
export function WebSearchDisplay({ results }: WebSearchDisplayProps) {
  ...
  return (
    <div className="mb-4">
      ...
      >
        <div className="flex items-center justify-center w-6 h-6 rounded-lg bg-linear-to-br from-blue-500/20 to-cyan-500/20 group-hover:from-blue-500/30 group-hover:to-cyan-500/30 transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="mt-3 space-y-2 p-3 rounded-2xl bg-linear-to-br from-blue-50/80 to-cyan-50/80 dark:from-blue-950/30 dark:to-cyan-950/30 border border-blue-200/50 dark:border-blue-800/30">
              {results.slice(0, 5).map((result, idx) => (
                <motion.div
                  ...
                  className="text-xs p-3 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200/60 dark:border-slate-700/40 backdrop-blur-xs"
                >
