...
export function KnowledgeDatasetDetailPage() {
  ...
  async function handleUpload(files?: FileList | File[]) {
    ...
    if (!datasetId || !files || files.length === 0) return;
      ...
      <div className="max-w-[1600px] mx-auto p-6">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-5">
            ...
            <Card className="p-5 bg-white border-slate-200 h-[calc(100vh-180px)]">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-slate-400">
                  ...
                  {docsQuery.isFetching ? "刷新中..." : "每2s 自动刷新"}
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        ...
        <DialogContent className="max-w-sm">
          ...
          <p className="text-sm text-slate-600">
            ...
            确定要删除知识库 <strong>{dataset?.name}</strong> 吗？此操作不可撤销，所有文档和片段都将被永久删除。          </p>
