  ...
  return (
    <div className="flex overflow-hidden bg-card -m-6" style={{ height: 'calc(100vh - 64px)', width: 'calc(100% + 48px)' }}>
      ...
      {playgroundSidebarOpen && (
        <aside
          className={cn(
            "w-[280px] flex-col border-r border-border/40 bg-linear-to-b from-muted/30 to-muted/10",
            isMobile
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pb-48 min-h-0 bg-background">
        {!serviceId ? (
          ...
          <div className="flex h-full items-center justify-center p-8">
            <div className="max-w-md rounded-3xl border border-border/60 bg-card/70 px-6 py-5 text-sm shadow-xs">
      ...
      {showScrollToBottom && messages.length > 0 && (
        <button
          ...
          className={cn(
            ...
            "bg-card/95 border border-border/60 shadow-lg backdrop-blur-xs",
      ...
      <div className="absolute bottom-0 left-0 w-full bg-linear-to-t from-background from-80% to-transparent pt-10 pb-5 px-6">
        <div className="mx-auto w-full max-w-4xl">
          <div className="rounded-2xl border border-border/60 bg-card/95 backdrop-blur-xs shadow-2xl shadow-black/10 dark:shadow-black/30 overflow-hidden ring-1 ring-black/5 dark:ring-white/5">
            <MultimodalInput
              onSend={handleSend}
