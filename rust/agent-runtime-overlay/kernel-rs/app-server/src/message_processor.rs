...
pub(crate) struct MessageProcessorArgs {
    ...
    pub(crate) host_runtime: AppServerHostRuntime,
}
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let thread_store = host_runtime.thread_store().unwrap_or_else(|| {
        ...
        let thread_manager = Arc::new_cyclic(|thread_manager| {
            ...
            let manager = ThreadManager::new(
                ...
                thread_extensions(
                    ...
                    host_runtime.extension_installer(),
                ),
    ...
    #[expect(
        ...
        reason = "typed in-process host options stay separate from public request fields"
    )]
    ...
    #[expect(
        clippy::too_many_arguments,
        reason = "initialized dispatch carries transport context plus host-only options"
    )]
