...
use crate::host_runtime::AppServerExtensionInstaller;
...
pub(crate) fn thread_extensions<S>(
    ...
    host_extension_installer: Option<Arc<dyn AppServerExtensionInstaller>>,
    ...
    S: AgentSpawner<StartThreadOptions, Spawned = NewThread, Error = CodexErr> + 'static,
{
    ...
    if let Some(installer) = host_extension_installer {
        installer.install(&mut builder);
    }
