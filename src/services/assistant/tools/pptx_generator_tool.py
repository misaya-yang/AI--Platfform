...
class PPTXGenerator:
    ...
    def _add_two_column_slide(
        ...
        # Left column
        left_box = shapes.add_textbox(
            Inches(0.5), Inches(1.6),
            Inches(5.8), Inches(5.4)
        )
        self._fill_column(left_box, left_content, theme)

        # Right column
        right_box = shapes.add_textbox(
        ...
        # Vertical divider
        divider = shapes.add_shape(
            1, Inches(6.5), Inches(1.6),
            Inches(0.03), Inches(5.4)
        )
        divider.fill.solid()
