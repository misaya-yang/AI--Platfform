...
class DocumentElement:
    ...
    # Relationships
    parent_id: Optional[str] = None     # Parent heading/section
...
class StructuredDocumentParser:
    ...
    def _create_image_chunk(
        ...
        descriptions.append(f"Image size: {element.metadata.get('width')}x{element.metadata.get('height')}")
