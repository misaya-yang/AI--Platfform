...
class InvocationContext:
    ...
    stream_response: AsyncIterator[StreamChunk] | None = None
...
class MiddlewareChain:
    ...
    def __init__(self, middlewares: list[InvocationMiddleware] | None = None):
        """
        Args:
            middlewares: 初始中间件列表
        """
    ...
    def get(self, name: str) -> InvocationMiddleware | None:
        """获取指定名称的中间件"""
