...
def register_adapter(
    ...
    invocation_modes: Optional[Set[str]] = None,
...
def get_adapter(name: str) -> Optional[Type[ProtocolAdapter]]:
    """获取已注册的适配器类"""
        ...
        try:
            ...
            for ep in adapter_eps:
                try:
                    ...
                    if (
                        inspect.isclass(adapter_class)
                        and issubclass(adapter_class, ProtocolAdapter)
                    ):
