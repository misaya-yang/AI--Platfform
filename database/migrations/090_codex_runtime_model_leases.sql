-- 090 — Secret-free Codex runtime snapshots and bounded model-plane leases.
--
...
BEGIN
    SELECT runtime_owner, kernel_revision
     ...
     FOR SHARE;
    IF v_owner IS DISTINCT FROM 'codex_candidate'
    ...
    INSERT INTO assistant_runs (
        ...
        'codex_harness', 'safe', 'off', FALSE, LEFT(p_request_preview, 500),
