...
-- source receipt while emitting paired Codex response items and durable
...
BEGIN
    ...
    IF v_approvals_table IS NOT NULL THEN
        ...
        LOOP
            v_payload := jsonb_build_object(
                'schema_version', 'codex-runtime-legacy-approval/v1',
            ...
            PERFORM append_assistant_runtime_item(
                ...
                v_approval->>'approval_id', 'codex/legacy_approval', 'approval',
