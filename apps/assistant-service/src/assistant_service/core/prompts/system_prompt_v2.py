...
from ai_gateway_core.agents import system_prompt as shared_system_prompt

CORE_ASSISTANT_PROMPT = shared_system_prompt.CORE_ASSISTANT_PROMPT
EXTERNAL_CONTENT_BOUNDARY = shared_system_prompt.EXTERNAL_CONTENT_BOUNDARY
EXTERNAL_CONTENT_BOUNDARY_TAG = shared_system_prompt.EXTERNAL_CONTENT_BOUNDARY_TAG
ensure_external_content_boundary = shared_system_prompt.ensure_external_content_boundary
