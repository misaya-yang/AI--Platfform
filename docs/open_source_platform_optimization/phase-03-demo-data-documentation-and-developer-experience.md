# Phase 03 - Demo Data Documentation And Developer Experience
...
**Goal:** Complete the Demo Data Documentation And Developer Experience slice while preserving prior phase contracts and downstream handoff boundaries.
...
```json
{
  ...
  "phase": {
    "id": "OSP-03",
    "number": "03",
    "title": "Demo Data Documentation And Developer Experience",
    "status": "passed",
    "type": "implementation",
    "repo_path": ".",
    "docs_path": "docs/open_source_platform_optimization",
    "phase_file": "docs/open_source_platform_optimization/phase-03-demo-data-documentation-and-developer-experience.md",
    "depends_on": [
      "OSP-02"
    ],
    "unlocks": [
  ...
  "goal": {
    "target": "Complete the Demo Data Documentation And Developer Experience slice while preserving prior phase contracts and downstream handoff boundaries.",
    "prompt": "Complete OSP-03 Demo Data Documentation And Developer Experience for `.` by following `docs/open_source_platform_optimization/phase-03-demo-data-documentation-and-developer-experience.md`; work on the matching feature-oracle item, preserve continuity with adjacent phases, write code facts back to the source packet and continuity ledger, stay inside the named edit boundaries, make the smallest requirement-satisfying change, and finish only after validation, regression, review, compliance, rollback, evidence, and acceptance gates pass or blockers are documented.",
    "plan_required": true,
    "plan_output": "docs/open_source_platform_optimization/reports/osp-03-demo-data-documentation-and-developer-experience-plan.md",
    "completion_report": "docs/open_source_platform_optimization/reports/osp-03-demo-data-documentation-and-developer-experience-report.md"
  },
  "runtime": {
  ...
  "context": {
    "read_first": [
      ...
      "docs/open_source_platform_optimization/phase-03-demo-data-documentation-and-developer-experience.md"
    ],
    "primary_context": [
      "docs/open_source_platform_optimization/README.md",
      "docs/open_source_platform_optimization/source-packet.md",
  ...
  "validation": {
    "commands": [
      {
        "id": "demo-surface-scan",
        "cwd": ".",
        "command": "find . -maxdepth 4 \\( -path './.git' -o -path './.venv' -o -path './node_modules' -o -path './web/node_modules' \\) -prune -o \\( -iname '*seed*' -o -iname '*demo*' -o -iname '*sample*' -o -iname '*fixture*' \\) -print | sort",
        "expected": "Existing demo, seed, sample, and fixture paths are listed before adding or documenting demo data.",
        "required": true
      },
      {
        "id": "seeded-route-smoke",
        "cwd": ".",
        "command": "scripts/new/seed-demo-data.sh --dry-run && uv run --extra dev --extra test pytest -q --no-cov tests/scripts/test_seed_demo_data.py && pnpm -C web e2e:opensource",
        "expected": "Demo seed dry-run, seed tests, and backend-free Playwright route smoke pass or blockers are recorded.",
        "required": true
      },
      {
        ...
        "expected": "OSP harness remains structurally valid after demo and documentation updates.",
        "required": true
      }
    ],
    "browser_checks": [
  ...
  "evidence": {
    "outputs": [
      "docs/open_source_platform_optimization/reports/osp-03-demo-data-documentation-and-developer-experience-report.md"
    ],
    "required_artifacts": [
      "phase report",
      "progress-log entry",
...
- PHASE_ID: OSP-03
- GOAL_TARGET: Complete the Demo Data Documentation And Developer Experience slice while preserving prior phase contracts and downstream handoff boundaries.
- GOAL_PROMPT: Complete OSP-03 Demo Data Documentation And Developer Experience for `.` by following `docs/open_source_platform_optimization/phase-03-demo-data-documentation-and-developer-experience.md`; work on feature-oracle item OSP-F004; preserve dependency continuity with OSP-02; write code facts and boundary decisions back before handoff; stay inside the named edit boundaries; make the smallest requirement-satisfying change; finish only after validation, regression, review, compliance, rollback, evidence, and acceptance gates pass or blockers are documented.
- DEPENDS_ON: OSP-02
...
- VALIDATION_COMMANDS: find . -maxdepth 4 \( -path './.git' -o -path './.venv' -o -path './node_modules' -o -path './web/node_modules' \) -prune -o \( -iname '*seed*' -o -iname '*demo*' -o -iname '*sample*' -o -iname '*fixture*' \) -print | sort; scripts/new/seed-demo-data.sh --dry-run; uv run --extra dev --extra test pytest -q --no-cov tests/scripts/test_seed_demo_data.py; pnpm -C web e2e:opensource; python3 /Users/misaya.yanghejazfs.com.au/.codex/skills/prd-phase-harness/scripts/validate_harness_prd.py docs/open_source_platform_optimization --strict --quality-score
...
- EVIDENCE_OUTPUT: `docs/open_source_platform_optimization/reports/osp-03-demo-data-documentation-and-developer-experience-report.md`
...
Execute OSP-03 by using the phase contract, updating OSP-F004, and preserving the dependency chain `OSP-00 Open Source Baseline Audit
...
- Depends on: OSP-02
- Unlocks: OSP-04
- Feature-oracle item: OSP-F004
- Continuity ledger: `docs/open_source_platform_optimization/continuity-ledger.md`
- Prior-phase evidence to inherit: the OSP-02 phase report, progress-log entry, oracle evidence, and continuity-ledger boundary notes
...
- Work needed to satisfy OSP-F004 for Demo Data Documentation And Developer Experience.
...
- Start with this phase file, `source-packet.md`, `continuity-ledger.md`, and the OSP-02 phase report.
...
OSP-03 must update OSP-F004, produce durable evidence, and write code/interface facts back so the next phase can continue without hidden chat context.
...
- OSP-F004 has evidence or a documented blocker.
- `docs/open_source_platform_optimization/reports/osp-03-demo-data-documentation-and-developer-experience-report.md` exists or is named as blocked evidence.
