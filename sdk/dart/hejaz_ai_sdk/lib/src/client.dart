/// Main SDK entry point for the Hejaz AI Assistant.
///
/// Usage:
/// ```dart
...
const sdkVersion = 'hejaz-ai-dart/1.0.0';

/// The main entry point for the Hejaz AI SDK.
///
...
class HejazAI {
  ...
  /// - [baseUrl] — Gateway base URL. Defaults to `https://api.hejaz.com`.
  ...
  HejazAI({
    ...
    this.baseUrl = 'https://api.hejaz.com',
    this.tenantId = '',
    this.userId,
