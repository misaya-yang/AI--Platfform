 ...
 *
 * <p>Obtained via {@link HejazAI#chat()}. Not intended for direct construction.
 *
...
public class ChatClient {
    ...
    public CompletableFuture<ChatResponse> send(ChatRequest request) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            } catch (HejazAIException e) {
                throw e;
            } catch (Exception e) {
                throw new HejazAIException("Chat request failed: " + e.getMessage(), e);
            }
        });
    }
    ...
    public void stream(ChatRequest request, StreamHandler handler) {
        ...
        try {
            ...
            if (response.statusCode() != 200) {
                ...
                var ex = HejazAIException.fromStatus(response.statusCode(), errorBody, null);
                handler.onError(ex);
                return;
            }
    ...
    private void checkStatus(int statusCode, String responseBody) {
        ...
        throw HejazAIException.fromStatus(statusCode, message, requestId);
    }
    ...
    private void dispatchEvent(StreamEvent event, StreamHandler handler,
        ...
        switch (type) {
            ...
            case EventType.ERROR -> {
                ...
                handler.onError(new HejazAIException(msg));
